...
namespace MadMaps.Terrains.MapMagic
{
    ...
    public class DingoTreeOutput : OutputGenerator, Layout.ILayered
    {
        ...
        public static void Process(global::MapMagic.CoordRect rect, Chunk.Results results, GeneratorsAsset gens, Chunk.Size terrainSize, Func<float, bool> stop = null)
        {
            ...
            List<TupleSet<DingoTreeOutput, Matrix>> allGensMasks = new List<TupleSet<DingoTreeOutput, Matrix>>();
            foreach (DingoTreeOutput gen in gens.GeneratorsOfType<DingoTreeOutput>(onlyEnabled: true, checkBiomes: true))
            {
                ...
                allGensMasks.Add(new TupleSet<DingoTreeOutput, Matrix>(gen, biomeMask));
            }
            ...
            for (int g = 0; g < allGensMasksCount; g++)
            {
                DingoTreeOutput gen = allGensMasks[g].item1;
            ...
            results.apply.CheckAdd(typeof(DingoTreeOutput), treesTuple, replace: true);
        }
        ...
        public IEnumerator Apply(global::MapMagic.CoordRect rect, Terrain terrain, object dataBox, Func<float, bool> stop = null)
        {
            ...
            for (int i = 0; i < treesTuple.item1.Length; i++)
            {
                ...
                var newTree = new DingoTreeInstance(treeInstance, prototypeList);
