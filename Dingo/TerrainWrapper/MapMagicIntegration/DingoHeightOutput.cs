...
namespace Dingo.Terrains.MapMagic
{
    ...
    public class DingoHeightOutput : OutputGenerator
    {
        ...
        public void Process(global::MapMagic.CoordRect rect, Chunk.Results results, GeneratorsAsset gens, Chunk.Size terrainSize, Func<float, bool> stop = null)
        {
            ...
            foreach (DingoHeightOutput gen in gens.GeneratorsOfType<DingoHeightOutput>(onlyEnabled: true, checkBiomes: true))
            {
...
#else
            results.apply.CheckAdd(typeof(DingoHeightOutput), heights2D, replace: true);
#endif
        }
