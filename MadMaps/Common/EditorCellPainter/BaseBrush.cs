...
namespace MadMaps.Common.Painter
{
    public abstract class BaseBrush : IBrush
    {
        ...
        public void DrawGizmos(MadMaps.Common.Painter.IPaintable canvas, 
            ...
            MadMaps.Common.Painter.Painter.InputState inputState, Rect rect, Matrix4x4 TRS)
        {
            ...
            {
                DrawSceneGizmos(canvas, gridManager, inputState, rect, TRS);
            }
        }

        protected abstract void DrawSceneGizmos(MadMaps.Common.Painter.IPaintable canvas, 
            MadMaps.Common.Painter.IGridManager gridManager, 
            MadMaps.Common.Painter.Painter.InputState inputState, Rect rect, Matrix4x4 TRS);
